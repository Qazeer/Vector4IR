...
Configuration files for sending logs, from various sources, using
[`Vector`](https://github.com/vectordotdev/vector) to `(H)ELK` or `Splunk` (as
well as the 30+ `sinks` supported by `Vector`).
